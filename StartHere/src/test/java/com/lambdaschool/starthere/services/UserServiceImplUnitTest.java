...
public class UserServiceImplUnitTest
{
    ...
    {
        assertEquals("business@lambdaschool.local", userService.loadUserByUsername("business@lambdaschool.local").getUsername());
    }
//
...
//    {
//        assertEquals("admin", userService.findUserById(4).getEmail());
//    }
//
//    @Test(expected = ResourceNotFoundException.class)
//    public void BA_findUserByIdNotFound()
//    {
//        assertEquals("admin", userService.findUserById(10).getEmail());
//    }
//
//    @Test
...
//    {
//        assertEquals("admin", userService.findByName("admin").getEmail());
//    }
//
//    @Test (expected = ResourceNotFoundException.class)
//    public void AA_findByUsernameNotfound()
//    {
//        assertEquals("admin", userService.findByName("turtle").getEmail());
//    }
//
//    @Test
